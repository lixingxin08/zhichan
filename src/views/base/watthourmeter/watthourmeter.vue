<template>
  <div class="administrativedivision flex_fs">
    ...
    <div class="content2">
      ...
      <a-button v-if="isselectdata.nodeType=='AREA'" style='width: 66px;margin-bottom: 20px;' type='primary' @click='edit({})'>增加</a-button>
      <a-table :scroll="{  y: 625 }" :columns="tableTitle" :data-source="tableData" bordered size="small" :pagination="pagination"
        ...
        <template slot="operation" slot-scope="text, record">
          <div class="flexrow flexac flexjc">
            ...
            <a href="#" style='font-size: 12px;' :disabled="isselectdata.nodeType !='AREA'" @click="edit(record)">编辑</a>
            <div style="height: 20px;width: 1px;background-color: #e5e5e5;margin-left: 20px;margin-right: 20px;"></div>
            <a-popconfirm :disabled="isselectdata.nodeType!='AREA'" title="确定删除？" ok-text="确定" cancel-text="取消"
              @confirm="confirmDelete(record)">
              <a href="#" v-if="isselectdata.nodeType=='AREA'" style='color: #FF0000;font-size: 12px;'>删除</a>
