  ...
  <div class="content2">
    <div class='flexrow flexac flexsb' style="margin-bottom: 20px;">
      <div class="flexrow flexac">
        ...
        <div class='title_tx' style="margin-left: 20px;">传感器状态:</div>
    ...
    <a-button :disabled="isselectdata.nodeType!='GLP'"class='base_add88_btn' type='primary' @click='edit({})'> <a-icon two-tone-color="#ffffff" type="plus" />新增</a-button>
...
<script>
  ...
  export default {
   ...
   if (!this.isselectdata) return
        ...
        let res = await this.$http.post(this.$api.deviceenvironmentalpage, param)
  ...
  let param = {
        ...
        let res = await this.$http.post(this.$api.deviceenvironmentalremove, param)
        if (res.data.resultCode == 10000) {
          this.getTableData()
