<template>
  <div class="content2">
    <div class="flexrow des-title">发布屏信息</div>
    <a-descriptions size='small' bordered>

      <a-descriptions-item label="发布屏型号">
        {{config.modelName}}
      </a-descriptions-item>
      <a-descriptions-item label="发布屏名称" :span="2">
        {{config.deviceName}}
      </a-descriptions-item>
      <a-descriptions-item label="发布屏编号">
        {{config.deviceCode}}
      </a-descriptions-item>
      <a-descriptions-item label="发布屏状态" :span="2">
