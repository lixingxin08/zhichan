<template>
  <div class="content2">
    <div class="flexrow des-title">WIFI信息</div>
    <a-descriptions size='small' bordered>

      <a-descriptions-item label="WIFI型号">
        {{config.modelName}}
      </a-descriptions-item>
      <a-descriptions-item label="WIFI名称" :span="2">
        {{config.deviceName}}
      </a-descriptions-item>
      <a-descriptions-item label="WIFI编号">
        {{config.deviceCode}}
      </a-descriptions-item>
      <a-descriptions-item label="WIFI状态" :span="2">
