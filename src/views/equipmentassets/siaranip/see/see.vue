<template>
  <div class="content2">
    <div class="flexrow des-title">广播信息</div>
    <a-descriptions size='small' bordered>

      <a-descriptions-item label="广播型号">
        {{config.modelName}}
      </a-descriptions-item>
      <a-descriptions-item label="广播名称" :span="2">
        {{config.deviceName}}
      </a-descriptions-item>
      <a-descriptions-item label="广播分机号">
        {{config.deviceCode}}
      </a-descriptions-item>
